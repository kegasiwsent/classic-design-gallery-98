...
const ServiceCategories = () => {
  ...
  return <section className="py-24 bg-gradient-to-b from-white to-gray-lightest" id="services">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {filteredServices.map((service, index) => <Link key={index} to={service.type === "kitchen" ? "/kitchen" : "#"} className="block">
              <ServiceCategory title={service.title} description={service.description} image={service.image} detailedDescription={service.detailedDescription} />
            </Link>)}
        </div>
      </div>
    </section>;
