...
const Header = () => {
  ...
  return <header className="w-full bg-transparent absolute top-0 z-50 backdrop-blur-sm">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center border-b border-white/10">
        <div className="flex items-center gap-2">
          <Link to="/" className="flex items-center">
            <img alt="JB Design Logo" src="/lovable-uploads/172a6183-431f-48c7-a892-6f5a6858717c.png" className="h-40 md:h-20 w-auto object-contain hover:scale-105 transition-all duration-300 animate-fade-in" />
          </Link>
        </div>
      ...
      {/* Mobile Menu */}
      {isMenuOpen && <div className="md:hidden bg-interior-navy/90 backdrop-blur-lg">
